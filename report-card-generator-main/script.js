...
function GenerateCard(){
    ...
    html2canvas($("#report-card-HTML"), { // DIV ID HERE
        onrendered: function(canvas) {
            ...
            doc.addImage(imgData, 'PDF', 100, 100);
            doc.save('report-carder.pdf'); //SAVE PDF FILE
        }
    });
...
function GenerateCard_bw(){
    ...
    html2canvas($(".table_bw-div"), { // DIV ID HERE
        onrendered: function(canvas) {
            ...
            var doc = new jsPDF('landscape');
            doc.addImage(imgData, 'PDF', 100, 100);
            doc.save('report-carder(b/w).pdf'); //SAVE PDF FILE
        }
    });
...
function GenerateCard() {
    ...
    html2canvas(element, {
        ...
        // Create PDF with A4 size dimensions in landscape
